...
//This program uses inheritance now!
...
public class stringCounter extends countAlgo { //class extension (inheritance)

	public static void main(String[] args){

		String userString;
		char[] charArray;
		stringCounter test = new stringCounter();
